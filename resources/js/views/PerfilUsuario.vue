<template>
    <div style="max-width:540px;margin:0 auto">
        ...
        <div v-if="camposFaltando.length" class="flex align-items-start gap-3 p-3 border-round mb-4"
...
const form  = reactive({ name: '', phone: '', cpf: '', birth_date: '', birth_date_display: '' });
